export const LAND_MARINE_STYLE = {
    "version": 8,
    "name": "imweather-combined-black",
    "metadata": {
    ...
    "center": [10.1844018282771, -1.13686837721616e-13],
    "zoom": 1,
    "bearing": 0,
    "pitch": 0,
    "sources": {
    ...
    "sprite": "https://maps.meteoplaza.com/styles/imweather-combined-black/sprite",
    ...
    "layers": [
      {
        ...
        "maxzoom": 24,
        "paint": {
          "background-color": "rgba(104, 146, 0, 1)"
        }
      },
      {
        "id": "ice",
      ...
      },
      {
        ...
        "filter": [
          ...
          [
            "!in",
            "$id",
            1312, 1314, 1922, 1873, 371, 369, 370, 1614, 374, 775]
        ],
        "layout": {
          "line-cap": "square",
          "line-join": "miter",
    ...
    "id": "imweather-combined-black",
    "owner": "sjoerd-infoplaza"
}