export const DARK_MARINE_STYLE = {
    "version": 8,
    "name": "offshore-land-overlay",
    "metadata": {
    ...
    "sources": {
        "openmaptiles": {
            "type": "vector",
            "url": "https://maps.meteoplaza.com/data/world-vector.json"
        },
        "land": {
            "type": "vector",
    ...
    "sprite": "https://maps.meteoplaza.com/styles/offshore-land-overlay/sprite",
