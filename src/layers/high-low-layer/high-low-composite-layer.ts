...
import {DEFAULT_TEXT_FORMAT_FUNCTION, DEFAULT_TEXT_FONT_FAMILY, DEFAULT_TEXT_SIZE, DEFAULT_TEXT_COLOR, DEFAULT_TEXT_OUTLINE_WIDTH, DEFAULT_TEXT_OUTLINE_COLOR, ensureDefaultProps} from '../../_utils/props';
...
import {isViewportInZoomBounds, getViewportPixelOffset, getViewportAngle} from '../../_utils/viewport';
  ...
  renderLayers(): LayersList {
    ...
    return [
      new TextLayer({
        ...
        getPosition: d => d.geometry.coordinates as unknown as Position,
