...
const sourceCode = `uniform particleUniforms {
  float viewportGlobe;
...
const tokens = {
  ...
  viewportGlobeCenter: 'viewportGlobeCenter',
  viewportGlobeRadius: 'viewportGlobeRadius',
  viewportBounds: 'viewportBounds',
  viewportZoomChangeFactor: 'viewportZoomChangeFactor',
