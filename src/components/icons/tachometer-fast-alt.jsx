const TachometerFastAltIcon = ({ className }) => {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="tachometer-fast-alt">
...
export default TachometerFastAltIcon