    ...
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
            <path fill="currentColor"
                d="M15.792 3.616a1.25 1.25 0 1 0-1.768 1.768a1.25 1.25 0 0 0 1.768-1.768m1.276 6.602a.75.75 0 1 0 .088-1.497l-2.082-.122a.75.75 0 0 1-.636-.432l-.784-1.68a1.593 1.593 0 0 0-2.568-.452L8.429 8.693a1.61 1.61 0 0 0 .386 2.562l2.056 1.089a.75.75 0 0 1 .399.668l-.018 2.659a.75.75 0 0 0 1.5.01l.018-2.66a2.25 2.25 0 0 0-1.197-2.003l-1.272-.673l2.385-2.387l.394.843a2.25 2.25 0 0 0 1.907 1.295z"/>
            <path fill="currentColor" fill-rule="evenodd"
                d="M2 15.75a3.75 3.75 0 1 1 7.5 0a3.75 3.75 0 0 1-7.5 0m3.75-2.25a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5m12.5-1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5M16 15.75a2.25 2.25 0 1 1 4.5 0a2.25 2.25 0 0 1-4.5 0"
                clip-rule="evenodd"/>
        </svg>
    )
}
